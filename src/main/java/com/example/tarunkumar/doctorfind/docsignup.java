...
public class docsignup extends AppCompatActivity {
    ...
    Button bt1;
    EditText first,last,phno,email,address,user_name,user_pass,user_con,department;
    TextView tv_use;
    String fn,ln,ph,em,add,u_n,u_p,u_c,dept,id;
    Context ctx=this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=ArrayAdapter.createFromResource(this,R.array.dept_name,android.R.layout.simple_spinner_item);
       ...
       // department = (EditText) findViewById(R.id.et_dept);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                x9=spinner.getSelectedItemPosition();
                x1=phno.length();
                x2=email.length();
                x3=user_name.length();
                x4=user_pass.length();
                ...
                if(x6==0){
                    ...
                    Toast.makeText(docsignup.this,
                            "Please select the department..", Toast.LENGTH_LONG).show();
                    return;
                }
