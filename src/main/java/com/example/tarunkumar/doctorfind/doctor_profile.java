    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationview.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if(item.getItemId()==R.id.home_id){
                    ...
                    Intent in = new Intent(doctor_profile.this, doctor_profile.class);
                    Bundle bn1 = new Bundle();
                    bn1.putString("user_name",usn);
                    bn1.putString("user_pass",passwo);
                    ...
                    editor.commit();
                    finish();
                    Intent in = new Intent(doctor_profile.this, MainActivity.class);
                    startActivity(in);
                }
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(doctor_profile.this,update.class);
                Bundle bn = new Bundle();
                bn.putString("user_name", usn);
                bn.putString("user_pass", passwo);
                bn.putString("record_id", record_id);
